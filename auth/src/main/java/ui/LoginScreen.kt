    ...
    AppTheme(){
        Surface(
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                RegularTextField(stringResource(R.string.textField1LoginScreen), Icons.Outlined.Email)
                PasswordTextField(stringResource(R.string.textField2LoginScreen), Icons.Outlined.Lock)
                Spacer(Modifier.height(250.dp))

                NFButton(stringResource(id= R.string.btnLoginScreen), onClick = {navController.navigate("welcomeScreen")})
